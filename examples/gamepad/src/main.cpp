...
void example_game::draw() {
    ...
    _sprite_batch->begin(graphics_device()->backbuffer_size() / 4);

    _sprite_batch->draw(_texture, { 0, 20, 20, 20 }, { _troll_position.x, _troll_position.y, 20.0f, 20.0f }, rb::color::white());
