...
namespace rb {
    struct texture_cube_desc {
        std::map<texture_cube_face, span<const std::uint8_t>> data;
        vec2i size = { 0, 0 };
    ...
    public:
         ...
         */
        virtual void update(texture_cube_face face, const span<const std::uint8_t>& pixels, const vec4i& area) = 0;
    ...
    protected:
         ...
         */
        texture_cube(const texture_cube_desc& desc);
