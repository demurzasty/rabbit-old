...
VkDescriptorSetLayout shader_vulkan::descriptor_set_layout() const RB_NOEXCEPT {
    return _descriptor_set_layout;
}

VkPipelineLayout shader_vulkan::pipeline_layout() const RB_NOEXCEPT {
    return _pipeline_layout;
}

VkPipeline shader_vulkan::pipeline() const RB_NOEXCEPT {
    return _pipeline;
}
