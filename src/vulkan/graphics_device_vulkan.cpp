...
void graphics_device_vulkan::draw(const std::shared_ptr<mesh>& mesh, const std::shared_ptr<material>& material, const std::shared_ptr<resource_heap>& resource_heap) {
    ...
    vkCmdBindDescriptorSets(_command_buffer,
        ...
        native_material->pipeline_layout(),
        0,
        1,
        &native_resource_heap->descriptor_sets()[0], 
        0,
        nullptr);
